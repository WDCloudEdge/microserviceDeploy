...
if __name__ == '__main__':
    ...
    ServiceGraph = remove_first_row_column(dataBaseFilePath + '70user_metrics/ServiceGraph.csv')
    ...
    ServiceResource = remove_first_row_column(dataBaseFilePath + '70user_metrics/ServiceResource.csv')
