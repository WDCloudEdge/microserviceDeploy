...
# bookinfo消融数据对比
# drdhr_w =[69.73569453181726, 82.01884722488202, 217.69059901973748, 592.2173925471443, 882.9375742069797]
# drdhr = [69.73569453181726, 82.9375742069797, 82.01884722488202, 217.69059901973748, 592.2173925471443]

# hipster消融数据对比
drdhr_w =[3414.6935026941965, 3566.6620318167415, 4042.7539049860234, 6567.109226803006, 12652.57375035587]
drdhr = [2651.22233758881, 2899.140346875999, 3405.2986345315876, 5926.109226803006, 11811.57375035587]


result = calculate_difference_percentage(drdhr_w, drdhr)
print(f"计算结果为: {result:.2f}%")


def plot_icss_style():
    x = [10, 50, 90, 200, 400]
    methods = ["Default", "RMS_DDPG", "RSDQL", "DRDHR"]
    ...
    plt.savefig('hipster_service_latency.pdf', bbox_inches='tight')
    plt.show()
