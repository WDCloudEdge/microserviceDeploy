...
for i in range(MAX_EPISODES):
    ...
    for t in range(24):
        ...
        print("**********************************")
        temp = 1
        while average_time_state > response_time_threshold and count < 10:
        ...
        with open('output.txt', 'a') as f:  # 'a' 表示追加模式，如果文件不存在会创建
            f.write('Episode/Step:%s/%s' % (i, t) + ' Reward: %f' % (ep_reward) + ' Explore: %.2f' % var[
                t] + " average_time_state is " + str(average_time_state) + '\n')
