...
EDGE_RADIUS = [100000, 1000000, 1000000, 100000,100000,100000]

EDGE_BANDWIDTH = [
    [0, 1000, 300, 300, 300, 300],
    [1000, 0, 300, 300, 300, 300],
    [300, 300, 0, 1000, 300, 300],
    [300, 300, 1000, 0, 300, 300],
    [300, 300, 300, 300, 0, 1000],
    [300, 300, 300, 300, 1000, 0]
]
#EDGE_CAPACITY = [[1800, 1300], [600, 900], [1500, 1800], [1400, 1300]]
#EDGE_CAPACITY = [[1000, 512], [1000, 512], [1000, 512], [1000, 512]]
SERVICE_SET = [[200, 128], [300, 300], [200, 128], [300, 128],[200, 128],
               [200, 128], [200, 128], [200, 128],[200, 450],[200, 128]]

#SERVICE_SET = [[500, 128], [500, 256], [500, 256], [500, 256],[500,256],[500, 128]]
...
def compute_system_response(t,state):
    avail_resource = [[1000, 512], [1000, 512], [1000, 512], [1000, 512],[1000, 512],[1000, 512]]
    all_response_time = 0
