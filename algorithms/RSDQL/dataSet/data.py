...
dom1 = xml.dom.minidom.parse(r'E:\research\my_deployment\algorithms\RSDQL\dataSet\data.xml')
root = dom1.documentElement
dom2 = ET.parse(r'E:\research\my_deployment\algorithms\RSDQL\dataSet\data.xml')
    ...
    def __init__(self):
        ...
        for oneper in dom2.findall('./number/serviceNumber'):
            for child in oneper:
                ...
                self.container_state_queue.append(int(child[0][0].text))
                self.container_state_queue.append(int(child[0][1].text))
