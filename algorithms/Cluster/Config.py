...
class Config():
    def __init__(self):
        ...
        # k8s config path
        self.k8s_config = r'E:\research\PBScaler-main\ku_config'
        ...
        # prometheus
        self.prom_range_url = "http://8.148.7.50:31212/graph/api/v1/query_range"
        self.prom_no_range_url = "http://8.148.7.50:31212/api/v1/query"
        self.step = 5