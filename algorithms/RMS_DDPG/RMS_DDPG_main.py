...
if __name__ == "__main__":
    ...
    for episode in range(MAX_EPISODES):
        ...
        print('episode: {} || reward: {:.4f} || t_min: {:.4f} || reward_s: {:.4f} || action_list:{}'.format(episode,step_rew,t_min,reward_buffer[-1],action_list))
