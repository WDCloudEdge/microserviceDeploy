...
class Config:
    def __init__(self):
        self.namespace = 'tset-node'
        self.nodes = None
        self.svcs = set()
        self.pods = set()

        self.interval = 5 * 60  # 每次收集数据的时间（10min）
        # self.interval = 60  
        ...
        self.prom_range_url_node = "http://192.168.31.182:31213/api/v1/query_range"  # 原生Prometheus
        self.prom_no_range_url_node = "http://192.168.31.182:31213/api/v1/query"
        self.prom_no_range_url = "http://192.168.31.182:31213/api/v1/query"
        self.step = 5
        ...
        # kubernetes
        self.k8s_config = r'E:\research\my_deployment\data_collect\config.yaml'  # kubernetes配置文件地址
